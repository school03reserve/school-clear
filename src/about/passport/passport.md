...
title: Паспорт закладу
description: Загальна інформація про Гімназію «ПРОСВІТ» — паспорт закладу освіти
permalink: /about/passport/
blocks:
  - type: styled_heading
    text: 🏫 Паспорт закладу освіти
    level: h2
    align: center
    color: blue
  - type: simple_text
  ...
  - type: document_links
    category_title: 📋 Документи закладу
    documents:
      - title: Статут гімназії
        url: https://docs.google.com/document/d/1tdac-mg145bFm9oKOpPfa-1D7mJ0lw5N/edit?usp=sharing
        icon: 📜
