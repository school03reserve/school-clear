...
blocks:
  - type: document_links
    ...
    documents:
      ...
      - title: Кошторис та фінансовий звіт про надходження та використання всіх
          отриманих коштів
      ...
      - title: Наявність вакантних посад
        url: https://drive.google.com/file/d/1Ngopq5EGOpp69wp4fI6eoNVLutgjc7mn/view?usp=sharing
        icon: 💼
        description: ""
      ...
      - title: Інша інформація що оприлюднюється за рішенням закладу освіти або на
